...
def banner():
    ...
    {cyan}  .'`---=___`===':{greenLight}   ____) | | | |  __/ | |  {yellow}| {red}Author : Dimax66
    {cyan} /_..---' ___.--.'{greenLight}  |_____/|_| |_|\___|_|_|  {yellow}| {red}Team   : Padang System Error
